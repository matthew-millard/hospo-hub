...
export const ACCEPTED_DOCUMENT_TYPES = ["application/pdf", "application/doc", "application/docx", "text/plain", "application/vnd.oasis.opendocument.text"];
...
export const publicEndorsementSchema = z.object({
  body: z.string().min(1, "Please provide a public endorsement.").max(500, "Public endorsement must be less than 500 characters."),
